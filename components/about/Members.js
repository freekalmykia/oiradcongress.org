...
export default function Members({memberSection, members}) {
  return (
    <section className="py-12 sm:py-20 lg:py-28 bg-gray-50">
      <div className="max-w-xl px-4 mx-auto sm:max-w-3xl sm:px-6 md:px-8 lg:max-w-screen-xl">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-base font-medium tracking-widest text-red-600 uppercase">{memberSection.subheading}</h2>
          <h3 className="mt-2 text-3xl font-medium tracking-normal text-gray-900 sm:text-4xl md:tracking-tight lg:leading-tight lg:text-5xl">{memberSection.heading}</h3>
          <p className="max-w-2xl mt-4 text-xl text-gray-500 lg:mx-auto">{memberSection.subtext}</p>
        </div>
